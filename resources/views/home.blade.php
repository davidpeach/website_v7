...
<head>
    <meta charset="utf-8">
    <title>David Peach | Raiding Tombs since 1996</title>
...
<body class="flex justify-center">
    <div class="max-w-4xl px-4">
        ...
        <h1 class="mt-3 text-4xl">David Peach</h1>
        <p class="mt-3 text-xl">Web Developer | Writer | Obssessed with puns</p>
        <p class="mt-6 p-1 text-sm text-center text-white bg-green-600">This is a temporary home page I knocked up in a about 30 minutes - the bulk of my content can be found on my <a href="https://blog.davidpeach.co.uk" class="text-white underline">blog</a>.</p>
